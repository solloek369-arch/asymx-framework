...
- `looking-glass/docs/engine_register.md` — wat bestaat er?
- `looking-glass/docs/engine_register.json` — machineleesbare engine-status
...
4. Geen nieuwe engine bouwen voordat hij in `looking-glass/docs/engine_register.md` staat.
...
- `workbench/chat-intake-level1/` — tag: `chat-intake-level1-v1.0`
- `workbench/story-filter-level1/` — tag: `story-filter-level1-v1.0`

Actuele released Level 1-lenzen:

1. `workbench/logistics-level1/`
2. `workbench/chat-intake-level1/`
3. `workbench/story-filter-level1/`

Zie ook: `looking-glass/docs/lens_registry.md`.

## Update — drie Level 1-lenzen zichtbaar

 huidige stand is bijgewerkt in:

- `looking-glass/docs/RELEASE_STATE.md`
- `looking-glass/docs/lens_registry.md`

Actuele released Level 1-lenzen:

1. `workbench/logistics-level1/` — `logistics-level1-v1.0`
2. `workbench/chat-intake-level1/` — `chat-intake-level1-v1.0`
3. `workbench/story-filter-level1/` — `story-filter-level1-v1.0`
