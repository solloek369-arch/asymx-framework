...
Huidige basis:
- Logistics Level 1 staat als publieke statische lokale lens in `workbench/logistics-level1/`.
- Release-tag: `logistics-level1-v1.0`.
- Engine Register v1 staat in `looking-glass/docs/engine_register.md` en `looking-glass/docs/engine_register.json`.
- Pressure Queue staat in `looking-glass/docs/pressure_queue.md`.
- Open Eindjes Register staat in `looking-glass/docs/open_eindjes_register.md`.
- Level 1 Open Field Map staat in `looking-glass/docs/level_1_open_field_map.md`.
...
1. Run `git status`.
2. Lees `looking-glass/docs/engine_register.md`.
3. Lees `looking-glass/docs/pressure_queue.md`.
4. Lees `looking-glass/docs/open_eindjes_register.md`.
