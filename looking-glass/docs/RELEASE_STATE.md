...
|---:|---|---|---|---|
| 01 | Logistics Level 1 / Static Shadow Run Lens | `workbench/logistics-level1/` | `logistics-level1-v1.0` | Logistieke frictie lokaal zichtbaar maken zonder upload of harde claims. |
| 02 | Chat Intake Vault | `workbench/chat-intake-level1/` | `chat-intake-level1-v1.0` | AI/chats veilig innemen; bron intact houden; eerste routing mogelijk maken. |
| 03 | Story Filter | `workbench/story-filter-level1/` | `story-filter-level1-v1.0` | Tekst splitsen in verhaalopbouw, herhaling en ruis/nu niet. |

## Actieve drukverlagende documenten

| Document | Functie |
|---|---|
| `looking-glass/docs/NOW.md` | Waar staan we nu? |
| `looking-glass/docs/engine_register.md` | Welke engines bestaan er? |
| `looking-glass/docs/engine_register.json` | Machineleesbare enginekaart |
| `looking-glass/docs/pressure_queue.md` | Wat vraagt nu aandacht? |
| `looking-glass/docs/open_eindjes_register.md` | Wat mag blijven liggen zonder hoofd-druk? |
| `looking-glass/docs/ai_session_sync_prompt.md` | Startprompt voor AI/Cursor-sessies |
| `looking-glass/docs/level_1_open_field_map.md` | Publieke Level 1 veldkaart |
...
9. Wat zichtbaar genoeg is, hoeft nu niet opnieuw gedragen te worden.
