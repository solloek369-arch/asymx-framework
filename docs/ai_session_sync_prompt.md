...
Huidige basis:
- Logistics Level 1 staat als publieke statische lokale lens in `logistics-level1/`.
- Release-tag: `logistics-level1-v1.0`.
- Engine Register v1 staat in `docs/engine_register.md` en `docs/engine_register.json`.
- Pressure Queue staat in `docs/pressure_queue.md`.
- Open Eindjes Register staat in `docs/open_eindjes_register.md`.
- Level 1 Open Field Map staat in `docs/level_1_open_field_map.md`.
...
1. Run `git status`.
2. Lees `docs/engine_register.md`.
3. Lees `docs/pressure_queue.md`.
4. Lees `docs/open_eindjes_register.md`.
